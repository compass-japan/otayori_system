...
.kenkoub{
  ...
  <?php
    ...
    $result = mysql_query("SELECT * FROM complet WHERE name1 = 2017 and name2 = 6",$cn1);
    $i=0;
      ...
      <input type="hidden" name="mmhg" value="$mmhg">
       ...
       <div id="print"><a href="#" onclick="document.s1.submit(); return false;"><img src="../img/back_l.png"></a></div>
          ...
          <Tr>
           ...
           <Tr>
           <Td width="1000" colspan="3" height="12" align="center"style="font-family :'Yu Gothic',sans-serif;font-size:25px;"><b>体重：　$km kg 　　血圧：　$mmhg mmHg</b></Td>
           </Tr>
            <Tr>
