...
.kenkoub{
  ...
  <?php
    ...
    $result = mysql_query("SELECT * FROM complet WHERE name1 = 2017 and name2 = 8",$cn1);
    $i=0;
    while($row = mysql_fetch_array($result))
    {
      ...
      <input type="hidden" name="mmhg" value="$mmhg">
       ...
       <div id="print"><a href="#" onclick="document.s1.submit(); return false;"><img src="../img/back_l.png"></a></div>
          ...
          <Table class="toptable" background="../img/back_summer.png" width="1100" height="553"style="border-style:solid;border-width:5px;
            border-color: #fff;table-layout: fixed;">
          <Tr>
           ...
           <Td height="200" align="center"><img class="ivent1" src="$photo0"></Td>
           </Tr>
           <Tr>
           <Td height="90"  valign="top" style="font-family :'Yu Gothic',sans-serif;text-align:center;"><Font size="6" color="" ><b>$capc</b></Font></Td>
           </Tr>
           <Tr>
           <Td width="1000" colspan="3" height="12" align="center"style="font-family :'Yu Gothic',sans-serif;font-size:25px;"><b>体重：　$kg kg 　　血圧：　$mmhg mmHg</b></Td>
           </Tr>
            <Tr>
